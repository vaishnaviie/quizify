      ...
      <div className="mt-7 w-full max-w-2xl rounded-3xl border border-[#D7DED7] bg-[#FBFAF5] p-5 shadow-[0_20px_50px_rgba(8,45,32,0.18)] sm:mt-8 sm:p-7">
        ...
        <div className="mt-5">
          ...
          <input
            ...
            className="mt-2 ml-4 w-20 rounded-xl border border-[#D7DED7] bg-[#F3F5EF] px-4 py-3 text-sm font-semibold text-[#17382B] outline-none transition focus:border-[#8DBB4C] focus:ring-4 focus:ring-[#DDF0B5]"
          />
        </div>
